...
$jscomp.findInternal = function (b, g, d) {
    ...
    for (var k = b.length, h = 0; h < k; h++) {
        var f = b[h];
        if (g.call(d, f, h, b)) return {i: h, v: f}
    }
    return {i: -1, v: void 0}
};
$jscomp.ASSUME_ES5 = !1;
...
$jscomp.polyfill = function (b, g, d, k) {
    if (g) {
        ...
        k = d[b];
        g = g(k);
        g != k && null != g && $jscomp.defineProperty(d, b, {configurable: !0, writable: !0, value: g})
    }
};
...
(function (b) {
    var g = b.fn.navDropdown, d = {ESC: 27, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40},
        k = {XS: 544, SM: 768, MD: 992, LG: 1200, XL: Infinity}, h = function () {
            function a(a, e) {
                "length" in a || (a = [a]);
                this.props = {};
            ...
            a.prototype.children = function (c) {
                ...
                b(this).each(function () {
                    var d = new a(this);
                    if (d.is(":root")) var f = b(this); else if (d.is(":toggle")) f = b(this).parent().find(">.dropdown-menu");
                    else return;
    ...
    f.prototype.toggle = function (a) {
        ...
        a = b(this.parentNode);
        var c = a.hasClass("open"), d = f._isCollapsed(b(this).closest(".nav-dropdown"));
        f._clearMenus(b.Event("click", {target: this, data: {toggles: d ? [this] : null}}));
        if (c) return !1;
    ...
    f._clearMenus =
        function (a) {
            ...
            if (3 !== a.which) {
                ...
                if (a.target) {
                    if (this === document) if (b(a.target).is("a:not([disabled], .disabled)")) var d = b.Event("collapse.bs.nav-dropdown", {relatedTarget: a.target}); else {
                ...
                for (g = 0; g < c.length; g++) {
                    var h = c[g].parentNode, k = {relatedTarget: c[g]};
    ...
    f._dataApiKeydownHandler = function (a) {
        if (!/input|textarea/i.test(a.target.tagName)) {
            var c, e;
            for (e in d) if (c = d[e] === a.which) break;
